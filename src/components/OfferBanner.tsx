  ...
  return (
    <div className="animate-rise-in mx-auto mb-4 flex w-full max-w-none items-center gap-3 rounded-card bg-ink px-4 py-3 text-cream shadow-raise">
      ...
      <Link
        ...
        prefetch
        onClick={() => track(event)}
        className="shrink-0 rounded-btn bg-signal px-4 py-2 text-sm font-semibold text-on-signal transition-transform duration-fast hover:-translate-y-px active:scale-95"
      >
        see the offer
      </Link>
      <button
