      ...
      {!capped ? (
          ...
          <div className="relative mt-3">
            ...
            {paletteOpen && (
              <div
                id="preview-palette"
                role="listbox"
                className="absolute z-20 mt-2 w-full overflow-hidden rounded-card bg-white shadow-lift ring-1 ring-inset ring-ink/10 animate-fade-through"
              >
        ...
        <div className="mt-4 rounded-card bg-cream-deep p-4 text-center">
          ...
          <div className="mt-3 flex flex-wrap justify-center gap-2">
            ...
            <button
              onClick={copyShare}
              className="inline-flex min-h-[44px] items-center rounded-btn px-5 py-2.5 text-sm font-bold lowercase ring-1 ring-inset ring-ink transition-colors hover:bg-white/60"
            >
