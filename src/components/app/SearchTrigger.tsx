  ...
  return (
    <>
      <button
        ...
        className="group hidden items-center gap-2 rounded-pill bg-cream-deep/70 py-1.5 pl-3 pr-1.5 text-sm font-semibold text-ink-soft ring-1 ring-inset ring-transparent transition-all duration-fast ease-brand-out hover:bg-cream-deep hover:text-ink hover:ring-line sm:inline-flex"
      >
        <Search size={14} strokeWidth={2.4} aria-hidden="true" />
        <span className="pr-6">Search</span>
        <kbd className="rounded-pill bg-surface/80 px-2 py-0.5 text-[10px] font-bold tracking-wide text-ink-soft shadow-soft">
          ⌘K
        </kbd>
      </button>
