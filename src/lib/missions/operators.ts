...
export const OPERATOR_PROFILES: Record<string, OperatorProfile> = {
  ...
  communication: {
    ...
    tools: ["gmail.search_related", "deliverable.followup", "approval.offer_send"],
    maxRuntimeMs: 25_000,
    maxRetries: 2,
  ...
  files: {
    ...
    tools: ["drive.search_files", "deliverable.brief", "deliverable.agenda", "deliverable.comparison", "laptop.report"],
    maxRuntimeMs: 25_000,
    maxRetries: 2,
  ...
  browser: {
    ...
    tools: ["browser.research", "browser.prepare_purchase", "laptop.search", "laptop.review"],
    maxRuntimeMs: 60_000,
    maxRetries: 2,
  ...
  research: {
    ...
    tools: ["analyze.extract", "laptop.compare", "laptop.recommend"],
    maxRuntimeMs: 45_000,
    maxRetries: 1,
