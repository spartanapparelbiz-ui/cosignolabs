...
export const OPERATOR_PROFILES: Record<string, OperatorProfile> = {
  ...
  files: {
    ...
    tools: ["drive.search_files", "deliverable.brief", "deliverable.agenda", "deliverable.comparison"],
    maxRuntimeMs: 25_000,
    maxRetries: 2,
  ...
  browser: {
    ...
    tools: ["browser.research", "browser.prepare_purchase"],
    maxRuntimeMs: 60_000,
    maxRetries: 2,
