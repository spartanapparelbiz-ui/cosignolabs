...
export const OPERATOR_PROFILES: Record<string, OperatorProfile> = {
  ...
  files: {
    ...
    tools: ["drive.search_files", "deliverable.brief", "deliverable.agenda", "deliverable.comparison", "deliverable.daily_brief", "laptop.report"],
    maxRuntimeMs: 25_000,
    maxRetries: 2,
  ...
  research: {
    ...
    tools: ["analyze.extract", "inbox.summarize", "laptop.compare", "laptop.recommend"],
    maxRuntimeMs: 45_000,
    maxRetries: 1,
