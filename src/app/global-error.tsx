    ...
    <html lang="en">
      ...
      >
        <svg width="48" height="48" viewBox="0 0 100 100" fill="none" aria-hidden="true">
          <path d="M 76 66.9 A 31 31 0 1 1 76 33.1" stroke="#141414" strokeWidth={26} strokeLinecap="round" />
          <path d="M 47 53 L 57 63 L 88 28" stroke="#FF4B1F" strokeWidth={17} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
        <div>
